# Hi there! I'm Dhruv Patel (DearDhruv) 👋
...
- **Languages:** Kotlin (Expert), Java, Swift, Dart.
- **UI & Frameworks:** Jetpack Compose (Modern UI), Adaptive Layouts (Foldables/Tablets), XML/View System.
- **Architecture:** Clean Architecture, MVVM, MVI, Modularization.
- **Advanced Android:** Media3 (Multimedia workflows), Hardware/Sensor Integrations, Performance Optimization.
- **Tools:** Gradle, Dagger/Hilt, Coroutines & Flow, KMP (Kotlin Multiplatform).

---

### 🚀 Recent Focus & Contributions
...
- 💬 **Ask me:** Happy to chat about Android, Kotlin, or tech leadership on [X](https://x.com/DearDhruv).
...
- 🧧 **Anime:** Appreciating the art and storytelling of Japanese animation.
